...
if (main_planned_NHST_run == TRUE) {
  ...
  # access sum coded models and the novel words reference grid from list
  lme_train_treatment_coded <- 
    planned_comparisons_NHST$lme_train_treatment_coded
  lme_test_treatment_coded <- planned_comparisons_NHST$lme_test_treatment_coded
  test_n_pair_grid <- planned_comparisons_NHST$test_n_pair_grid
