...
wordcount         : "14,449"
note              : "Article published in Journal of Experimental Psychology: General. The final article is accessible via its DOI: 10.1037/xge0000778"
...
Parameter estimates, confidence intervals (for the frequentist analysis), and credible intervals (for the Bayesian analysis) are presented in Table\ \@ref(tab:ex3-train). As in all previous experiments, we found a main effect of block attesting performance improvement over the course of training. Similar to Experiment 1, the quadratic term also reached significance confirming nonlinearity of the learning trajectory. We also confirmed the main effect of task which indicates that reading performance exceeded spelling performance. The interaction between block and task suggests that while performance was similar across tasks at the outset, learning progressed more rapidly for reading than for spelling.
